...
<body>
                            ...
                            <li class="scroll-to-section">
                                @auth
                                    <a href="{{ url('/showcart', Auth::user()->id) }}">
                                        Cart <span style="color: orangered; font-weight: 700;">({{ $count }})</span>
                                    </a>
                                </li>
                            @endauth
    ...
    <div id="top">
        ...
        <table align="center" bgcolor="rgba(250, 90, 90, 0.54)"
            style="padding-top: 80px; margin-top: 80px; text-align: center;">
            <tr>
